...
namespace MvcForms.Tests
{
    ...
    public class ChoiceFieldTest
    {
        ...
        public void WidgetTest()
        {
            ...
            Assert.IsInstanceOfType(target.Widget, typeof(MvcForms.Widgets.Select));
        }
        ...
        public void ChoicesTest()
        {
            ...
            Assert.AreSame(target.Choices, MvcForms.Widgets.Choices.AustralianStates.Abbreviated);
        }
        ...
        {
            ChoiceField target = new ChoiceField(new MvcForms.Widgets.SelectMultiple());
